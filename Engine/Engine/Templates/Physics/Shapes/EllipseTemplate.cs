namespace Dive.Engine.Templates.Physics.Shapes
{
    ...
    /// <summary>
    /// Template for ellipse physics entities.
    /// </summary>
    [EntityTemplate(Name = "Engine.Physics.Shapes.Ellipse")]
    public class EllipseTemplate : ITemplate
    {
        /// <summary>
        ...
        public Entity BuildEntity(Entity entity, params object[] args)
        {
            ...
            entity.AddComponent<EllipseComponent>();
