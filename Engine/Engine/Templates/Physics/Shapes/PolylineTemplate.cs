namespace Dive.Engine.Templates.Physics.Shapes
{
    ...
    /// <summary>
    /// Template for polyline physics entities.
    /// </summary>
    [EntityTemplate(Name = "Engine.Physics.Shapes.Polyline")]
    public class PolylineTemplate : ITemplate
    {
        /// <summary>
        ...
        public Entity BuildEntity(Entity entity, params object[] args)
        {
            ...
            entity.AddComponent<PolylineComponent>();
